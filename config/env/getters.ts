const getNodeEnv                = ({ NODE_ENV }: Readonly<NodeJS.ProcessEnv>) => NODE_ENV ?? 'production';
...
const getBuildAnalyze           = ({ BUILD_ANALYZE }: Readonly<NodeJS.ProcessEnv>) => BUILD_ANALYZE ?? false;
...
const getUseCriticalCSSOptimize = ({ USE_CRITICAL_CSS_OPTIMIZE }: Readonly<NodeJS.ProcessEnv>) =>
